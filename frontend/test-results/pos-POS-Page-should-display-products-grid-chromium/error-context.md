...
- Name: pos.spec.ts >> POS Page >> should display products grid
- Location: e2e\pos.spec.ts:21:3
...
Call log:
  - → GET http://localhost:5173/api/settings
    ...
    - authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJmZTMxMDNkOC0wNDY3LTRlODYtOTcxOS03NTg4YTg0ZjkzNzAiLCJlbWFpbCI6ImFkbWluQG15cG9zLmNvbSIsInJvbGUiOiJBRE1JTiIsImlhdCI6MTc3OTI2NjgwMCwiZXhwIjoxNzc5MjcwNDAwfQ.PlkI1SuRhQ6mpdKP4XQCVTWSXu7-q7bwJ9nKnhr3aYQ
