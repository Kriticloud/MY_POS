...
- Name: kitchen.spec.ts >> Kitchen Page >> should show action buttons for orders
- Location: e2e\kitchen.spec.ts:31:3
...
Call log:
  - → GET http://localhost:5173/api/settings
    ...
    - authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJmZTMxMDNkOC0wNDY3LTRlODYtOTcxOS03NTg4YTg0ZjkzNzAiLCJlbWFpbCI6ImFkbWluQG15cG9zLmNvbSIsInJvbGUiOiJBRE1JTiIsImlhdCI6MTc3OTI2NjUwNiwiZXhwIjoxNzc5MjcwMTA2fQ.Ki6VxL9cQU9eQ-Io7Ajzg88xprUH702VZMtDMmIpbWA
